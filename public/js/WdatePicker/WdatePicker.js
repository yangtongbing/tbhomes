...
(function() {
    var $ = {
        ...
        qsEnabled: true,
        autoShowQS: false,
        specialDates: null, xs_r:null,specialDays: null, disabledDates: null, disabledDays: null, opposite: false, onpicking: null, onpicked: null, onclearing: null, oncleared: null, ychanging: null, ychanged: null, Mchanging: null, Mchanged: null, dchanging: null, dchanged: null, Hchanging: null, Hchanged: null, mchanging: null, mchanged: null, schanging: null, schanged: null, eCont: null, vel: null, elProp: "", errMsg: "", quickSel: [], has: {}, getRealLang: function() {
            var _ = $.$langList;
    ...
    A = J();
    if ($.$wdate)
        K(A + "../../css/WdatePicker/skin/WdatePicker.css");
    U = X;
    if ($.$crossFrame) {
        try {
    ...
    function I(G, _) {
        ...
        function E(F, E) {
            ...
            for (var I = 0; I < C.length; I++)
                if (C[I].name == E.skin)
                    G.push("<link rel=\"stylesheet\" type=\"text/css\" href=\"" + A + "../../css/WdatePicker/skin/" + C[I].name + "/datepicker.css\" charset=\"" + C[I].charset + "\"/>");
